	...
	return (
		<main className="flex flex-1 flex-col items-center justify-center gap-6 px-6 py-16 text-center">
			<div className="flex flex-col gap-2">
				<h1 className="text-2xl font-bold tracking-tight">로그인했습니다</h1>
				<p role="status" className="text-sm leading-relaxed text-zinc-500">
					이제 찜한 팝업과 내 일정을 쓸 수 있습니다.
				</p>
			</div>
			<LinkButton href={destination} size="lg">
				이어서 하기
			</LinkButton>
		</main>
	);
