...
export default function HomePage() {
	return (
		<main className="flex flex-1 flex-col gap-8 px-5 py-6">
			...
			<Link
				href="/planner"
				className="flex flex-col gap-1 rounded-2xl bg-blue-600 p-5 text-white transition-colors hover:bg-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
			>
